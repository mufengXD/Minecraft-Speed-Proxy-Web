    ...
    <div class="main-content">
      <header class="top-banner">
        ...
        <div class="banner-right">
          <div class="banner-item" @click="openGitHub">
          ...
          <div class="banner-item" @click="openSettings">
          ...
          <div class="banner-item" @click="logout">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
...
export default {
  ...
  data() {
    return {
      menu: [
        { name: '主页', path: '/online' },
        { name: '白名单', path: '/whitelist' },
        { name: '黑名单', path: '/blacklist' }
